...
const CheckoutThankYouHeader = React.createClass( {
	...
	getText() {
		...
		} else if ( isDomainRegistration( this.props.primaryPurchase ) ) {
		...
		} else if ( isDomainMapping( this.props.primaryPurchase ) ) {
		...
		} else if ( isGoogleApps( this.props.primaryPurchase ) ) {
